...
(function () {
  ...
  var T = {
    es: {
      open_title:"¡YA ESTAMOS AQUÍ!", open_sub:"Ven a visitarnos · Playa de la Rubina",
      open_hero1:"ESTAMOS", open_hero2:"ABIERTOS",
      ...
      perk1:"Descuento exclusivo en tu primera visita", perk2:"24 de Junio — Playa de la Rubina",
      ...
      success_title:"¡Ya eres de los nuestros!", success_sub:"Te hemos guardado el descuento.<br>Nos vemos el <strong>24 de Junio</strong> en Playa de la Rubina!",
    ...
    ca: {
      open_title:"JA SOM AQUÍ!", open_sub:"Vine a visitar-nos · Playa de la Rubina",
      open_hero1:"ESTEM", open_hero2:"OBERTS",
      ...
      perk1:"Descompte exclusiu en la teva primera visita", perk2:"24 de Juny — Playa de la Rubina",
      ...
      success_title:"Ja ets dels nostres!", success_sub:"T'hem guardat el descompte.<br>Ens veiem el <strong>24 de Juny</strong> a Playa de la Rubina!",
    ...
    fr: {
      open_title:"ON EST LÀ!", open_sub:"Venez nous rendre visite · Playa de la Rubina",
      open_hero1:"NOUS SOMMES", open_hero2:"OUVERTS",
      ...
      success_title:"Tu fais partie des nôtres!", success_sub:"On a gardé ta réduction.<br>Rendez-vous le <strong>24 Juin</strong> à Playa de la Rubina!",
    ...
    en: {
      open_title:"WE'RE OPEN!", open_sub:"Come visit us · Playa de la Rubina",
      open_hero1:"WE'RE", open_hero2:"OPEN!",
      ...
      perk1:"Exclusive discount on your first visit", perk2:"June 24th — Playa de la Rubina",
      ...
      success_title:"You're one of us!", success_sub:"We've saved your discount.<br>See you on <strong>June 24th</strong> at Playa de la Rubina!",
    ...
    de: {
      open_title:"WIR SIND GEÖFFNET!", open_sub:"Besucht uns · Playa de la Rubina",
      open_hero1:"WIR SIND", open_hero2:"GEÖFFNET!",
      ...
      perk1:"Exklusiver Rabatt bei deinem ersten Besuch", perk2:"24. Juni — Playa de la Rubina",
      ...
      success_title:"Du bist dabei!", success_sub:"Wir haben deinen Rabatt gespeichert.<br>Bis zum <strong>24. Juni</strong> in Playa de la Rubina!",
    ...
    it: {
      open_title:"SIAMO APERTI!", open_sub:"Vieni a trovarci · Playa de la Rubina",
      open_hero1:"SIAMO", open_hero2:"APERTI!",
      ...
      perk1:"Sconto esclusivo alla tua prima visita", perk2:"24 Giugno — Playa de la Rubina",
      ...
      success_title:"Sei dei nostri!", success_sub:"Abbiamo salvato il tuo sconto.<br>Ci vediamo il <strong>24 Giugno</strong> a Playa de la Rubina!",
    ...
    nl: {
      open_title:"WE ZIJN OPEN!", open_sub:"Kom ons bezoeken · Playa de la Rubina",
      open_hero1:"WE ZIJN", open_hero2:"OPEN!",
      ...
      perk1:"Exclusieve korting bij je eerste bezoek", perk2:"24 Juni — Playa de la Rubina",
      ...
      success_title:"Je bent erbij!", success_sub:"We hebben je korting opgeslagen.<br>Tot <strong>24 Juni</strong> in Playa de la Rubina!",
    ...
    ru: {
      open_title:"МЫ ОТКРЫТЫ!", open_sub:"Приходите к нам · Playa de la Rubina",
      open_hero1:"МЫ", open_hero2:"ОТКРЫТЫ!",
      ...
      perk1:"Эксклюзивная скидка на первый визит", perk2:"24 Июня — Playa de la Rubina",
      ...
      success_title:"Вы с нами!", success_sub:"Мы сохранили вашу скидку.<br>Увидимся <strong>24 Июня</strong> на Playa de la Rubina!",
  ...
  function initCountdown() {
    ...
    function showOpenNow() {
      ...
      setTimeout(function () {
        ...
        /* Cambiar título hero: GRAN INAUGURACIÓN → ESTAMOS ABIERTOS */
        document.querySelectorAll("[data-i18n='title1']").forEach(function (el) {
          el.textContent = t.open_hero1 || "ESTAMOS";
        });
        document.querySelectorAll("[data-i18n='title2']").forEach(function (el) {
          el.textContent = t.open_hero2 || "ABIERTOS";
        });

        /* Tiras: cambiar a redes sociales */
        var openTicker = " INSTAGRAM @costaburrito_empuriabrava · TIKTOK @empuriabravacostaburrito · PLAYA DE LA RUBINA · EMPURIABRAVA ·";
        document.querySelectorAll("[data-i18n-tape]").forEach(function (el) {
          el.textContent = openTicker;
        });
        document.querySelectorAll("[data-i18n-marquee]").forEach(function (el) {
          el.textContent = openTicker;
        });
  ...
  function initForm() {
    ...
    function showSuccess() {
      /* Fijar altura del wrap ANTES de ocultar el form para evitar saltos de layout */
      if (wrap) wrap.style.minHeight = wrap.offsetHeight + "px";

      /* Ocultar form: hidden + display:none explícito porque .reg-form{display:flex}
         tiene igual especificidad que [hidden]{display:none} del user-agent y lo gana */
      ...
      setTimeout(function () { if (success) success.scrollIntoView({ behavior: "smooth", block: "center" }); }, 150);
    }
  }
